...
class KoopmansCPCalculator(CalculatorCanEnforceSpinSym, CalculatorExt, Espresso_kcp, CalculatorABC):
    ...
    def __init__(self, atoms: Atoms, alphas: Optional[List[List[float]]] = None,
        ...
        if has_nlcc and (self.parameters.nr1b is None or self.parameters.nr2b is None or self.parameters.nr3b is None):
            print("\n   Small box parameters \"nrb\" not given in input: going to set to a safe default values")
            ...
            nr3 = good_fft(nr3)
            #
            print ("   Array leading dimensions ( nr1 , nr2 , nr3  )   = ", nr1, nr2, nr3)
            ...
            # NOTA BENE: I assume here 3 Bohr is a safe choice: all the rc in the DOJO pseudos are <= 2.4
            #import ipdb
            #ipdb.set_trace()
            rc_safe=3.0
