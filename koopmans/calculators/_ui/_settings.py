...
valid_settings: List[settings.Setting] = [
    ...
    settings.Setting('use_ws_distance',
    ...
    settings.Setting('smooth_int_factor',
                     ...
                     (int, list), 1, None),
    settings.Setting('dft_ham_file', '', str, None, None),
    settings.Setting('dft_smooth_ham_file', '', str, None, None),
    settings.Setting('do_dos',
