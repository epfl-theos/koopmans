...
def run_koopmans(workflow_type, master_cpi, alpha_guess=0.6, alpha_from_file=False, n_max_sc_steps=1, from_scratch=False):
    '''
...
if __name__ == '__main__':
    ...
    run_workflow(args.orbdep, args.template, args.alpha,
