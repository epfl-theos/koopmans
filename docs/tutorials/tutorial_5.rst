...
:download:`python script <../../tutorials/tutorial_5/perturb_positions.py>` that applies random noise to the unperturbed atomic positions of a water molecule. The resulting atomic positions are saved in a :download:`xyz-file <../../tutorials/tutorial_5/h2o_convergence_ml.json>` and visualized below
...
The input file for running a convergence analysis for the machine learning model can be downloaded :download:`here <../../tutorials/tutorial_5/h2o_convergence_ml.json>`. 

First, we have to specify the corresponding task in the ``workflow`` block:

.. literalinclude:: ../../tutorials/tutorial_5/h2o_convergence_ml.json
  :lines: 2-4
  :linenos:
  :emphasize-lines: 2
...
.. literalinclude:: ../../tutorials/tutorial_5/h2o_convergence_ml.out
  :lines: 18-19
  :language: text
  :lineno-start: 18
...
.. figure:: ../../tutorials/tutorial_5/spin_0_alphas_MAE_convergence.png
   :width: 1000
   :align: center
   :alt: The 20 snapshots generated with perturb_positions.py 
...
.. figure:: ../../tutorials/tutorial_5/spin_0_evs_MAE_convergence.png
   :width: 1000
   :align: center
   :alt: The 20 snapshots generated with perturb_positions.py 
...
The corresponding :download:`input file <../../tutorials/tutorial_5/h2o_trajectory_ml.json>` differs from the previous input file only in the ``"task"`` keyword

.. literalinclude:: ../../tutorials/tutorial_5/h2o_trajectory_ml.json
  :lines: 2-4
  :linenos:
  :emphasize-lines: 2
...
.. literalinclude:: ../../tutorials/tutorial_5/h2o_trajectory_ml.out
  :lines: 49-59
  :language: text
  :lineno-start: 49
