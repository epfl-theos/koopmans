"""Testing the `koopmans.processes.ui` module."""
...
def test_ui_si(silicon, tmp_path, datadir, check_patch):
    """Test the UnfoldAndInterpolateProcess on bulk silicon."""
    with chdir(tmp_path):
        atoms = silicon['atoms']
        parameters = UnfoldAndInterpolateSettingsDict(
            smooth_int_factor=2, w90_calc='pc', do_map=True, use_ws_distance=True,
        ...
        proc = ui.UnfoldAndInterpolateProcess(
            atoms=atoms,
