...
CONTAINS
  ...
  SUBROUTINE setup_scell_fft
    ...
    WRITE(542,*) DP
    WRITE(542,*) alat
    WRITE(542,*) (bg_cp(1:3,i), i=1,3)
    WRITE(542,*) (at_cp(1:3,i), i=1,3)
    WRITE(542,'(F20.10, 2I10, L)') gcutm, ngmcp_g, ngmcp, gamma_only_x
    ...
    WRITE(543,*) SIZE(g_cp)
    do i = 1, ngmcp ! NICOLA 
    WRITE( 202, fmt="( I6, 2I6, 3I4 )" ) i, i, i, mill_cp(1,i), mill_cp(2,i), mill_cp(3,i)
    WRITE(543,'(i5, 3x, 3F20.10, 3x, F20.10)') i, g_cp(:,i), gg_cp(i)
    enddo
    !
