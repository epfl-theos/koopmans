subroutine pw2cp_empty (seedname, iknum, ikstart, empty_start_index, nbnd_empty_to_save, spin_component, force_spin_symmetry)
  ...
  do ik=1, iknum
     ...
     WRITE(stdout,*) "NICOLA davcio called"
     call gk_sort (xk(1,ik), ngm, g, ecutwfc/tpiba2, npw, igk, g2kin)
     WRITE(stdout,*) "NICOLA gk_sort called"
     !
     ...
     !
  enddo ! k-points
  WRITE(stdout,*) "NICOLA end k-point"
  !
  counter_tot = counter
  WRITE(stdout,*) "NICOLA counter=", counter, nbnd, nbnd-empty_start_index+1
  !
  ...
  write(stdout,*) "NICOLA allocated c0, nbnd_empty_to_save", nbnd_empty_to_save
  !
