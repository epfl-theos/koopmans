...
! Module  s p i n
  ...
  logical,           public, save :: only_signatures
  logical,           public, save :: do_phases
...
contains
  ...
  !===================================================================  
    ...
    !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ! RICCARDO: phases and signatures for interpolation
    !%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    do_phases         = .false.
    call param_get_keyword('do_phases',found,l_value=do_phases)
    
    only_signatures   = .false.
    call param_get_keyword('only_signatures',found,l_value=only_signatures) 
