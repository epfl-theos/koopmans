...
!!!!  
       ...
       close(file_unit)
 WRITE(6,*) "======== U_opt matrix"

       if(have_disentangled) then
          r_wvfn=cmplx_0
          do loop_w=1,num_wann
             do loop_b=1,num_inc
           WRITE(6,*) loop_b, loop_w, ik, u_matrix_opt(loop_b, loop_w, ik)                 
             ...
             do nxx=-((ngs(1))/2)*ngx,((ngs(1)+1)/2)*ngx-1
                ...
                do loop_b=1,num_wann
                   do loop_w=1,num_wannier_plot            
                      ...
                      ! NLN
                      !WRITE(6,*) '================== U matrix ======================='
                      !WRITE(6,*) loop_b, wannier_plot_list(loop_w), loop_kpt, u_matrix(loop_b,wannier_plot_list(loop_w),loop_kpt)
                   end do
                end do
             end do
          end do
